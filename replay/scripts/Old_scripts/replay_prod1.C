//////////////////////////////////////////////////////////////////////////
//
// Transversity Replay Script  -- First Generation Farm Production Replay
//
//////////////////////////////////////////////////////////////////////////
//	
// May 2009 : Jin Huang
...
void replay_prod1(Int_t runnumber=0,Int_t all=0,Int_t fstEvt=0,Bool_t QuietRun = kTRUE)
{
...
//   analyzer->EnableBenchmarks();
   ...
   "%s/e06010_prod1_%d.root", //output file format
   "replay_prod1.odef",    	//out define
   "replay_prod1.cdef",    	//empty cut define
   kTRUE,                 	//replay scalar?
