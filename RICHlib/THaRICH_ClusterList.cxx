...
Int_t THaRICH_Hit::Compare( const TObject* theOtherHit ) const
{
  if (fADC < static_cast<const THaRICH_Hit*>( theOtherHit )->fADC)
    return -1;
  if (fADC > static_cast<const THaRICH_Hit*>( theOtherHit )->fADC)
    return +1;
  else
...
//_____________________________________________________________________________
void THaRICH_Hit::Show(FILE * fout1, FILE* fout2) 
{
...
void THaRICH_Hit::Show(FILE * fout1) 
{
  // FIXME comment on fprintf(fout1...) should be changed accordingly 
  // when ntuple will be created
...
//=============================================================================
THaRICH_Cluster::THaRICH_Cluster() :
...
//_____________________________________________________________________________
THaRICH_Cluster::THaRICH_Cluster( const THaRICH_Cluster& rhs ) :
  ...
  fResolved_noise_cut_success(rhs.fResolved_noise_cut_success)
{
  ...
  if( rhs.fHitList && (rhs.fHitList->GetSize() > 0 )) {
    ...
    while( THaRICH_Hit* pHit = static_cast<THaRICH_Hit*>( next() ))
      fHitList->AddLast(pHit);
  }
}

//_____________________________________________________________________________
THaRICH_Cluster& THaRICH_Cluster::operator=( const THaRICH_Cluster& rhs )
{
  // Assignment operator
...
//_____________________________________________________________________________
void THaRICH_Cluster::Clear( Option_t* opt )
{
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Dist( const THaRICH_Cluster* c ) const
{
...
//_____________________________________________________________________________
void THaRICH_Cluster::Insert( THaRICH_Hit* theHit )
{
...
//_____________________________________________________________________________
void THaRICH_Cluster::Insert( THaRICH_Hit* theHit, Float_t factor )
{
...
//_____________________________________________________________________________
void THaRICH_Cluster::Insert_Photon(Int_t flag, Float_t angle_to_add,
				    Int_t ResolvedFlag)
{
...
void THaRICH_Cluster::Insert_chi2(Int_t flag, Float_t chi2_to_add)
{
...
//____________________________________________________________________________
void THaRICH_Cluster::Insert_chi2_corrected(Int_t flag, Float_t chi2,
				    Int_t ResolvedFlag)
{
  // add a photon to the MIP
...
//____________________________________________________________________________
void THaRICH_Cluster::Insert_N_chi2_corrected_Photon(Int_t flag, Int_t N_Photon, Int_t ResolvedFlag)
{
  // add a photon to the MIP
...
//____________________________________________________________________________
void THaRICH_Cluster::Insert_MaximumLikelihood(Int_t flag, 
...
//____________________________________________________________________________
  void THaRICH_Cluster::Setchi2_prob(Int_t flag, Float_t chi2_value, 
...
//____________________________________________________________________________
  void THaRICH_Cluster::Setchi2_corrected_prob(Int_t flag, Float_t chi2_value,
					       Int_t N_Photon, 
					       Int_t ResolvedFlag)
{
  // calculate chi2 probability
...
//_____________________________________________________________________________
void THaRICH_Cluster::Setnoise_cut_success(Int_t value, Int_t ResolvedFlag)
{
  if(ResolvedFlag == 0)
    {
...
//_____________________________________________________________________________
void THaRICH_Cluster::SetN_Photon(Int_t i, Int_t Value, Int_t ResolvedFlag)
{
  if(ResolvedFlag == 0)
    {
      N_Photon[i] = Value;
...
//_____________________________________________________________________________
void THaRICH_Cluster::Setangle(Int_t i, Float_t Value, Int_t ResolvedFlag)
{
  if(ResolvedFlag == 0)
    {
      angle[i] = Value;
...
//_____________________________________________________________________________
void THaRICH_Cluster::Setangle_corrected(Int_t i, Float_t Value, 
					 Int_t ResolvedFlag)
{
  if(ResolvedFlag == 0)
    {
...
//_____________________________________________________________________________
Int_t THaRICH_Cluster::GetN_Photon(Int_t i, Int_t ResolvedFlag) const     
{
  if(ResolvedFlag == 0)
    {
      return N_Photon[i];
...
//_____________________________________________________________________________
Int_t THaRICH_Cluster::GetNphot_pi(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
      return N_Photon[0];
...
//_____________________________________________________________________________
Int_t THaRICH_Cluster::GetNphot_k(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
      return N_Photon[1];
...
//_____________________________________________________________________________
Int_t THaRICH_Cluster::GetNphot_p(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
      return N_Photon[2];
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Getangle(Int_t i, Int_t ResolvedFlag) const       
{
  if(ResolvedFlag == 0)
    {
      return angle[i];
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Getangle_pi(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
      return angle[0];
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Getangle_k(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
      return angle[1];
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Getangle_p(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
      return angle[2];
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Getangle_corrected(Int_t i, Int_t ResolvedFlag) const       
{
  if(ResolvedFlag == 0)
    {
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Getangle_corrected_pi(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Getangle_corrected_k(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
...
//_____________________________________________________________________________
Float_t THaRICH_Cluster::Getangle_corrected_p(Int_t ResolvedFlag) const             
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
 Int_t THaRICH_Cluster::GetN_chi2_phot_pi(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
 Int_t THaRICH_Cluster::GetN_chi2_phot_k(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
 Int_t THaRICH_Cluster::GetN_chi2_phot_p(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Float_t    THaRICH_Cluster::Getchi2_pi(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
      return chi2[0];
...
//____________________________________________________________________________
Float_t    THaRICH_Cluster::Getchi2_k(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
      return chi2[1];
...
//____________________________________________________________________________
Float_t    THaRICH_Cluster::Getchi2_p(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
      return chi2[2];
...
//____________________________________________________________________________
Float_t    THaRICH_Cluster::Getchi2_prob_pi(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
      return chi2_prob[0];
...
//____________________________________________________________________________
Float_t    THaRICH_Cluster::Getchi2_prob_k(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
      return chi2_prob[1];
...
//____________________________________________________________________________
Float_t    THaRICH_Cluster::Getchi2_prob_p(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
      return chi2_prob[2];
...
//____________________________________________________________________________
Float_t    THaRICH_Cluster::Getchi2_prob(Int_t flag, Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Int_t THaRICH_Cluster::GetN_chi2_corrected_phot_pi(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Int_t THaRICH_Cluster::GetN_chi2_corrected_phot_k(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Int_t THaRICH_Cluster::GetN_chi2_corrected_phot_p(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Float_t THaRICH_Cluster::Getchi2_corrected_pi(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Float_t THaRICH_Cluster::Getchi2_corrected_k(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Float_t THaRICH_Cluster::Getchi2_corrected_p(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Float_t THaRICH_Cluster::Getchi2_corrected_prob_pi(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Float_t THaRICH_Cluster::Getchi2_corrected_prob_k(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Float_t THaRICH_Cluster::Getchi2_corrected_prob_p(Int_t ResolvedFlag) const 
{
  if(ResolvedFlag == 0)
    {
...
//____________________________________________________________________________
Float_t    THaRICH_Cluster::Getchi2_corrected_prob(Int_t flag, 
...
//____________________________________________________________________________
Int_t  THaRICH_Cluster::Getnoise_cut_success(Int_t ResolvedFlag) const
{
  if(ResolvedFlag == 0)
    {
...
//_____________________________________________________________________________
Int_t THaRICH_Cluster::Test( const THaRICH_Hit* theHit, Float_t par1, 
...
//_____________________________________________________________________________
Int_t THaRICH_Cluster::FindLocalMaximumNumber( )
{
  ...
  next.Reset();
  while( THaRICH_Hit* pHitSave = static_cast<THaRICH_Hit*>( next() )) {
    Int_t I_Position = pHitSave->GetI();
    Int_t J_Position = pHitSave->GetJ();

    TIter next1( next );
    while( THaRICH_Hit* pHit = static_cast<THaRICH_Hit*>( next1() )) {
...
//---------------------------------------------------------------------------
Int_t THaRICH_Cluster::FindResolvedClusterElements
  ( const THaRICH_Hit* theLocalMaximum, THaRICH_Cluster* resolvedCluster,
  ...
  //           Hit is attributed to several resolved clusters).
{
  ...
  const THaRICH_Hit* pHit = theLocalMaximum;
  THaRICH_Hit* newHit = new( (*resolvedHits)[nResolvedHits++] ) 
    THaRICH_Hit( *pHit );
  ...
  TIter next( fHitList );
  while( (pHit = static_cast<THaRICH_Hit*>( next() ))) {
    if( ( TMath::Abs(pHit->GetI() - fIRef) + 
      ...
      while( THaRICH_Hit* pHit1 = static_cast<THaRICH_Hit*>( next2() )) {
	...
	if( (!pHit1->GetVeto()) &&
	  ...
	  while( THaRICH_Hit* pHit2 = 
		 static_cast<THaRICH_Hit*>( next5() )) {
      ...
      newHit = new( (*resolvedHits)[nResolvedHits++] ) THaRICH_Hit( *pHit );
  ...
  while( (pHit = static_cast<THaRICH_Hit*>( next() ))) {
	...
	while( THaRICH_Hit* pHit1 = static_cast<THaRICH_Hit*>( next4() )){
	  if( (!pHit1->GetVeto()) &&
	      ( TMath::Abs(pHit1->GetI() - fIofHit) + 
		TMath::Abs(pHit1->GetJ() - fJofHit)  == 1) ){
	    SumofCharges = SumofCharges + pHit1->GetADC();
...
//_____________________________________________________________________________
void THaRICH_Cluster::Show( FILE* fout1, FILE* fout2 ) const
{
  ...
  if( fHitList ) {
    TIter next(fHitList);
    while (THaRICH_Hit* d = (THaRICH_Hit*)next()) {   
      d->Show(fout1, fout2);
    }
  }
...
//_____________________________________________________________________________
void THaRICH_Cluster::Show( FILE* fout1) const
{
  //Print info about cluster statistics and all the hits in the cluster.
...
//_____________________________________________________________________________
void THaRICH_Cluster::ShowElements(FILE * fout)  const
{
  fprintf(fout,"\n");
...
ClassImp(THaRICH_Hit)
ClassImp(THaRICH_Cluster)
