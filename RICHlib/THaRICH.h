...
public:
  ...
  THaRICH_Hit*         GetHit(Int_t i) const 
    { return (THaRICH_Hit*)fHits->At(i); }
  THaRICH_Hit*         GetResolvedHit(Int_t i) const 
    { return (THaRICH_Hit*)fResolvedHits->At(i); }
  THaRICH_Cluster*     GetCluster(Int_t i) const 
    { return (THaRICH_Cluster*)fClusters->At(i); }
  THaRICH_Cluster*     GetResolvedCluster(Int_t i) const 
    { return (THaRICH_Cluster*)fResolvedClusters->At(i); }
...
protected:
  ...
  THaRICH_Cluster** fMIPs;          //MIP clusters for each track
  THaRICH_Cluster   fMIP;           //MIP cluster of the Golden Track
